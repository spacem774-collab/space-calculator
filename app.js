(function () {
  ...
  var HATCH = '<defs><pattern id="diagramHatch" width="6" height="6" patternUnits="userSpaceOnUse"><path d="M0 0 L6 6" stroke="#aaa" stroke-width="0.5" fill="none"/></pattern></defs>';
  var DIAGRAMS = {
    pipe_round: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<circle cx="55" cy="50" r="32" class="diagram-stroke" stroke-width="2"/><circle cx="55" cy="50" r="20" class="diagram-fill diagram-stroke" stroke-width="1.5"/><line x1="55" y1="18" x2="55" y2="8" class="diagram-stroke" stroke-width="1"/><line x1="87" y1="50" x2="98" y2="50" class="diagram-stroke" stroke-width="1"/><line x1="130" y1="25" x2="195" y2="25" class="diagram-stroke" stroke-width="1"/><text x="55" y="5" class="diagram-label" text-anchor="middle">D</text><text x="100" y="54" class="diagram-label">S</text><text x="162" y="22" class="diagram-label" text-anchor="middle">L</text></svg>',
    circle: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<circle cx="50" cy="50" r="38" class="diagram-fill diagram-stroke" stroke-width="2"/><line x1="50" y1="12" x2="50" y2="2" class="diagram-stroke" stroke-width="1"/><line x1="110" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="50" y="0" class="diagram-label" text-anchor="middle">D</text><text x="152" y="54" class="diagram-label" text-anchor="middle">L</text></svg>',
    sheet: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<rect x="25" y="22" width="130" height="56" class="diagram-fill diagram-stroke" stroke-width="2"/><line x1="25" y1="50" x2="8" y2="50" class="diagram-stroke" stroke-width="1"/><line x1="155" y1="78" x2="155" y2="92" class="diagram-stroke" stroke-width="1"/><line x1="90" y1="22" x2="90" y2="8" class="diagram-stroke" stroke-width="1"/><text x="5" y="54" class="diagram-label">T</text><text x="158" y="88" class="diagram-label">W</text><text x="90" y="4" class="diagram-label" text-anchor="middle">L</text></svg>',
    angle: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<path d="M25 75 L25 22 L78 22" class="diagram-fill diagram-stroke" stroke-width="2.5"/><line x1="25" y1="48" x2="8" y2="48" class="diagram-stroke" stroke-width="1"/><line x1="51" y1="22" x2="51" y2="8" class="diagram-stroke" stroke-width="1"/><line x1="95" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="5" y="52" class="diagram-label">a</text><text x="51" y="6" class="diagram-label" text-anchor="middle">t</text><text x="145" y="54" class="diagram-label" text-anchor="middle">L</text></svg>',
    angle_unequal: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<path d="M25 75 L25 30 L70 22" class="diagram-fill diagram-stroke" stroke-width="2.5"/><line x1="25" y1="52" x2="8" y2="52" class="diagram-stroke" stroke-width="1"/><line x1="47" y1="22" x2="47" y2="8" class="diagram-stroke" stroke-width="1"/><line x1="70" y1="48" x2="85" y2="48" class="diagram-stroke" stroke-width="1"/><line x1="105" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="5" y="56" class="diagram-label">a</text><text x="47" y="6" class="diagram-label" text-anchor="middle">t</text><text x="86" y="52" class="diagram-label">b</text><text x="150" y="54" class="diagram-label" text-anchor="middle">L</text></svg>',
    channel: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<path d="M45 18 L45 82 L95 82 L95 18" class="diagram-fill diagram-stroke" stroke-width="2"/><line x1="70" y1="50" x2="70" y2="35" class="diagram-stroke" stroke-width="1"/><line x1="115" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="70" y="30" class="diagram-label" text-anchor="middle">N</text><text x="155" y="54" class="diagram-label" text-anchor="middle">L</text></svg>',
    ibeam: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<path d="M50 15 L50 85 M50 28 L88 28 L88 72 L50 72 M42 28 L12 28 L12 72 L42 72" class="diagram-fill diagram-stroke" stroke-width="2"/><line x1="50" y1="50" x2="50" y2="32" class="diagram-stroke" stroke-width="1"/><line x1="105" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="50" y="28" class="diagram-label" text-anchor="middle">N</text><text x="150" y="54" class="diagram-label" text-anchor="middle">L</text></svg>',
    pipe_rect: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<rect x="28" y="18" width="72" height="64" class="diagram-stroke" stroke-width="2"/><rect x="38" y="28" width="52" height="44" class="diagram-fill diagram-stroke" stroke-width="1.5"/><line x1="64" y1="18" x2="64" y2="5" class="diagram-stroke" stroke-width="1"/><line x1="100" y1="50" x2="115" y2="50" class="diagram-stroke" stroke-width="1"/><line x1="140" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="64" y="2" class="diagram-label" text-anchor="middle">a</text><text x="117" y="54" class="diagram-label">b</text><text x="167" y="54" class="diagram-label" text-anchor="middle">t, L</text></svg>',
    square: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<rect x="32" y="15" width="52" height="52" class="diagram-fill diagram-stroke" stroke-width="2" transform="rotate(-12 58 41)"/><line x1="58" y1="41" x2="58" y2="28" class="diagram-stroke" stroke-width="1"/><line x1="100" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="58" y="24" class="diagram-label" text-anchor="middle">a</text><text x="147" y="54" class="diagram-label" text-anchor="middle">L</text></svg>',
    rebar: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<circle cx="48" cy="50" r="36" class="diagram-fill diagram-stroke" stroke-width="2"/><line x1="48" y1="14" x2="48" y2="4" class="diagram-stroke" stroke-width="1"/><line x1="100" y1="50" x2="195" y2="50" class="diagram-stroke" stroke-width="1"/><text x="48" y="2" class="diagram-label" text-anchor="middle">D</text><text x="147" y="54" class="diagram-label" text-anchor="middle">L</text></svg>',
    strip: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<rect x="28" y="32" width="135" height="36" class="diagram-fill diagram-stroke" stroke-width="2"/><line x1="28" y1="50" x2="8" y2="50" class="diagram-stroke" stroke-width="1"/><line x1="163" y1="68" x2="163" y2="88" class="diagram-stroke" stroke-width="1"/><line x1="95" y1="32" x2="95" y2="15" class="diagram-stroke" stroke-width="1"/><text x="4" y="54" class="diagram-label">t</text><text x="165" y="84" class="diagram-label">W</text><text x="95" y="10" class="diagram-label" text-anchor="middle">L</text></svg>',
    bend: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<path d="M32 68 Q82 68 82 18" class="diagram-stroke" stroke-width="10" stroke-linecap="round" fill="none"/><path d="M28 64 Q78 64 78 14" class="diagram-fill diagram-stroke" stroke-width="6" fill="none"/><line x1="32" y1="68" x2="32" y2="88" class="diagram-stroke" stroke-width="1"/><line x1="57" y1="43" x2="72" y2="52" class="diagram-stroke" stroke-width="1"/><text x="32" y="95" class="diagram-label" text-anchor="middle">D</text><text x="74" y="55" class="diagram-label">S</text><text x="98" y="22" class="diagram-label">R, угол</text></svg>',
    flange: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<circle cx="100" cy="50" r="46" class="diagram-stroke" stroke-width="2"/><circle cx="100" cy="50" r="26" class="diagram-fill diagram-stroke" stroke-width="1.5"/><line x1="100" y1="4" x2="100" y2="0" class="diagram-stroke" stroke-width="1"/><line x1="146" y1="50" x2="168" y2="50" class="diagram-stroke" stroke-width="1"/><line x1="100" y1="76" x2="100" y2="92" class="diagram-stroke" stroke-width="1"/><text x="100" y="-4" class="diagram-label" text-anchor="middle">D нар</text><text x="170" y="54" class="diagram-label">D вн</text><text x="108" y="88" class="diagram-label">t</text></svg>',
    reducer: '<svg class="diagram-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">' + HATCH + '<path d="M32 50 L52 26 L52 74 Z" class="diagram-stroke" fill="none" stroke-width="2"/><path d="M52 26 L152 46 L152 54 L52 74" class="diagram-fill diagram-stroke" stroke-width="2"/><line x1="32" y1="50" x2="15" y2="50" class="diagram-stroke" stroke-width="1"/><line x1="92" y1="50" x2="92" y2="68" class="diagram-stroke" stroke-width="1"/><line x1="152" y1="50" x2="188" y2="50" class="diagram-stroke" stroke-width="1"/><text x="12" y="54" class="diagram-label">D1</text><text x="92" y="75" class="diagram-label" text-anchor="middle">H</text><text x="191" y="54" class="diagram-label">D2</text><text x="92" y="38" class="diagram-label" text-anchor="middle">S</text></svg>'
  };
  ...
  const diagramEl = document.getElementById('sortament-diagram');
  ...
  function renderDiagram() {
    ...
    diagramEl.innerHTML = sort && DIAGRAMS[sort.id] ? DIAGRAMS[sort.id] : '';
  }
